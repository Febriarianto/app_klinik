                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="name">Nomor Rekam Medis</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nomor_rm" aria-label="readonly input example" value="{{ $data->nomor_rm ?? $no_rm }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="name">Nama :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Pasien" value="{{ $data->nama ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="name">No HP :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="no_tlp" name="no_tlp" placeholder="Masukkan No HP Pasien" value="{{ $data->no_tlp ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="name">Jenis Kelamin :</label>
                            <div class="col-sm-9">
