                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-light password-toggle" type="button"><svg class="svg-inline--fa fa-eye fa-w-18" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
        ...
        <div class="col-sm-12 col-lg-4 text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <img id="avatar" @if(isset($data['image'])) src="{{ $data['image'] != NULL ? asset("storage/images/original/".$data['image']) : asset('images/avatars/01.png') }}" @else src="{{ asset('images/avatars/01.png') }}" @endif style="object-fit: cover; border: 1px solid #d9d9d9" class="mb-2 border-2 mx-auto" height="200px" width="200px" alt="">
        ...
        $.each(
            ...
            function(x) {
                $(this).click(function(y) {
                    ...
                    let i = $(this).find('svg').toggleClass("fa-eye fa-circle-xmark");
