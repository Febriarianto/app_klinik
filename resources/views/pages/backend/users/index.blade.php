        ...
        $('#dataTable').DataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, full, meta) {
                        if (data !== null) {
                            return `<img src="{{ asset ('/storage/images/thumbnail/${data}') }}" style="max-width:100px; max-height: 100px;" class="rounded-circle img-thumbnail">`
                        }
                        return `<img src="{{ asset ('/images/avatars/01.png') }}" style="max-width:100px; max-height: 100px;" class="rounded-circle img-thumbnail">`
                    },
                },
                {
                    data: 'name',
