...
class RoleController extends Controller
{
  ...
  {
    $this->middleware('can:roles-list', ['only' => ['index', 'show']]);
  ...
  public function index(Request $request)
  {
    ...
    return view('pages.backend.roles.index', compact('config'));
  }
  ...
  public function create()
  {
    ...
    return view('pages.backend.roles.form', compact('config', 'permissions'));
  }
  ...
  public function edit($id)
  {
    ...
    return view('pages.backend.roles.form', compact('config', 'data', 'permissions'));
  }
